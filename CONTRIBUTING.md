...
https://metacpan.org/release/Meta-Grapher-Moose

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Meta::Grapher::Moose
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Meta::Grapher::Moose
...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/Meta-Grapher-Moose).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Meta-Grapher-Moose)
or [via email](bug-meta-grapher-moose@rt.cpan.org.
